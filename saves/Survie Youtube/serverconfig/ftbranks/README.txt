...
Last README file update: Sat Dec 14 12:53:37 CET 2024
...
command.gamerule.dimthread_active
command.gamerule.dimthread_active.value
command.gamerule.dimthread_thread_count
command.gamerule.dimthread_thread_count.value
...
command.hfm
command.hfm.clear_everyones_chunks
command.hfm.clear_my_chunks
command.hfm.clear_players_chunks
command.hfm.clear_players_chunks.player
command.hfm.get_my_chunks
command.hfm.protect
command.hfm.protect.value
command.hfm.query
command.home
command.home.name
command.ie
